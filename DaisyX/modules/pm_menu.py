...
"CAACAgUAAxkBAAEDUI1hlnwmeBqvWvYJC5QsfKCLjBFc4gACAwQAAg3psVRrVHoJa2s-6SIE",

"CAACAgUAAxkBAAEDUI9hlnwqJrbEW2B8RBzpGOTv_MvgJgADBAACl6KhVBQCp6rmcCLiIgQ",
    "CAACAgQAAxkBAAEDUAFhlhG0bupksPnFMhQ2N2NkwdfySgACkgQAAss-lSFO7gSkTHdYfSIE",

"CAACAgQAAxkBAAEDUAJhlhG06jUGp9JlTrXqc9Z316xEagACuAQAAss-lSECYOWMyvmRlSIE",

"CAACAgUAAxkBAAEDUANhlhG0PNZKKv7MNxQz5TN3aK684wACRQIAAv6P-FRBc29UNNT5UCIE",

"CAACAgUAAxkBAAEDUARhlhG0YBL8b8_n5zBo1YL_4tn4UgACrQADfHIJMB0AAcWa0M_ScSIE",

"CAACAgUAAxkBAAEDUAVhlhG0CGZyknA0xGLJ8iTtRzOSCAACzwADfHIJMEzg9Z0fIQnTIgQ",

"CAACAgUAAxkBAAEDUAZhlhG0ztRYL1lqgcsoeEQJnu6vvgACswADfHIJMDJQcXoPha2QIgQ",

"CAACAgUAAxkBAAEDUAdhlhG0vAO1suaiFob2h87yMoTJMwADBAACl6KhVBQCp6rmcCLiIgQ",
)
...
@register(cmds="start", no_args=True, only_pm=False)
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        InlineKeyboardButton(
            "➕ᴀᴅᴅ ꜱᴀɴᴀ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ",
            url=f"https://telegram.me/TheMinatozakisanabot?startgroup=true",
        )
    )
